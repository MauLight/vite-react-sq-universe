...
function Dramatic2_Lesson() {
    return (
        <div className='h-[200px] md:h-[400px] xl:h-[600px] mt-[100px]'>
            <div className='flex h-[100%]'>
                <img className='rounded-[30px] w-[100%] h-[100%] object-cover object-top' src={lesson02} />
            </div>
            <div className="inner">
                <div className="absolute top-[22%] left-[87%]">
                    <h1 className='text-black font-secondary text-4xl xl:text-8xl'>02</h1>
                ...
                <div className="absolute top-[50%] left-[65%] sm:top-[58%] sm:left-[70%] min-[1080px]:top-[64%] min-[1342px]:top-[68%] min-[1342px]:left-[60%]">
                    <p className='text-black font-tertiary hidden min-[1080px]:flex text-sm min-[1342px]:text-2xl'>Build the foundation of your <b className='mx-1'>CHARACTER ARC</b>.</p>
...
export default TiltWrapper(Dramatic2_Lesson, "Dramatic2_Lesson");
