        ...
        <div className='h-[200px] md:h-[400px] xl:h-[600px] mt-[100px]' >
            ...
            <div className="inner">
                <div className="absolute top-[22%] left-[87%]">
                    <h1 className='text-black font-secondary text-4xl xl:text-8xl'>01</h1>
                ...
                <div className="absolute top-[50%] left-[65%] sm:top-[58%] sm:left-[70%] min-[1080px]:top-[64%] min-[1342px]:top-[68%] min-[1342px]:left-[60%]">
                    <p className='text-black font-tertiary hidden min-[1080px]:flex text-sm min-[1342px]:text-2xl'>Design the central <b className='mx-1'>CONFLICT</b> of your story.</p>
