    ...
    return (
        <div className='h-[350px]'>
            <div className='flex h-[100%]'>
                ...
                <img className='rounded-[30px] w-[100%] object-cover object-center' src={quotes[length].img} />
            </div>
            <div className="inner">
                <div className="absolute z-50 top-[65%] left-[60%]">
                    ...
                    <p className='text-white font-tertiary ml-auto md:text-xl pl-2' >{quotes[length].author}</p>
                </div>
            </div>
        </div>
    )
